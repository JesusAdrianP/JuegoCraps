...
public class GUIGridBagLayout extends JFrame {
    ...
    public static final String MENSAJE_INICIO= "Bienvenido a Craps \n"
            ...
            + "\nSi sacas cualquier otro valor se establecerá el Punto"
    ...
    private void initGUI() {
        ...
        mensajeSalida.setText("Use el botón (?) para ver las reglas del juego");
    ...
    private class Escucha implements ActionListener, MouseListener, MouseMotionListener {
        ...
        public void mouseDragged(MouseEvent e) {
            setLocation(ventana.getLocation().x+e.getX()-x,ventana.getLocation().y+e.getY()-y);
